...
type ColorTheme = 'default' | 'blue' | 'green' | 'purple' | 'red' | 'orange' | 'dark';
...
const colorThemes = {
  default: {
    ...
    button: 'bg-slate-800 hover:bg-slate-700 text-white disabled:bg-gray-400 disabled:cursor-not-allowed',
  ...
  blue: {
    ...
    inputFocus: 'focus:ring-blue-500 focus:border-blue-500 focus:ring-2',
    inputError: 'border-red-500 focus:ring-red-500 focus:border-red-500',
    button: 'bg-blue-600 hover:bg-blue-700 text-white disabled:bg-blue-400 disabled:cursor-not-allowed',
  ...
  green: {
    ...
    inputError: 'border-red-500 focus:ring-red-500 focus:border-red-500',
    button: 'bg-green-600 hover:bg-green-700 text-white disabled:bg-green-400 disabled:cursor-not-allowed',
  ...
  purple: {
    ...
    inputError: 'border-red-500 focus:ring-red-500 focus:border-red-500',
    button: 'bg-purple-600 hover:bg-purple-700 text-white disabled:bg-purple-400 disabled:cursor-not-allowed',
  ...
  red: {
    ...
    button: 'bg-red-600 hover:bg-red-700 text-white disabled:bg-red-400 disabled:cursor-not-allowed',
  ...
  orange: {
    ...
    inputError: 'border-red-500 focus:ring-red-500 focus:border-red-500',
    button: 'bg-orange-600 hover:bg-orange-700 text-white disabled:bg-orange-400 disabled:cursor-not-allowed',
  ...
  dark: {
    ...
    inputFocus: 'focus:ring-blue-500 focus:border-blue-500 focus:ring-2',
    inputError: 'border-red-500 focus:ring-red-500 focus:border-red-500',
    button: 'bg-blue-600 hover:bg-blue-700 text-white disabled:bg-gray-600 disabled:cursor-not-allowed',
    buttonFocus: 'focus:ring-blue-600 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900',
    buttonLoading: 'bg-blue-500 cursor-not-allowed',
...
const LoginForm = ({
  ...
  return (
    ...
    >
      ...
      {/* Success Message */}
      {success && (
        <div className={`mb-4 p-3 rounded-lg bg-green-50 border border-green-200`} role="alert">
      ...
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        <div>
          ...
          >
            Your email <span className={theme.accent} aria-label="required">*</span>
          </label>
          <div className="relative">
            <Mail className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${theme.mutedText} w-5 h-5`} aria-hidden="true" />
            <input
              id="email"
              type="email"
              value={email}
          ...
          {errors?.email && (
            <p id="email-error" className={`mt-1 text-sm ${theme.error}`} role="alert">
              {errors.email}
            </p>
          )}
        </div>
        <div>
          <label
            ...
            className={`block text-sm font-medium ${theme.text} mb-2`}
          >
            Your password <span className={theme.accent} aria-label="required">*</span>
          </label>
          <div className="relative">
            <Lock className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${theme.mutedText} w-5 h-5`} aria-hidden="true" />
            <input
              id="password"
              type="password"
              value={password}
          ...
          {errors?.password && (
            <p id="password-error" className={`mt-1 text-sm ${theme.error}`} role="alert">
              {errors.password}
            </p>
          )}
        </div>
        <div className="flex items-center justify-between">
          <label className="flex items-center space-x-2 cursor-pointer">
            <input
              ...
              disabled={loading}
            />
            <span className={`text-sm ${theme.text} ${loading ? 'opacity-50' : ''}`}>Remember me</span>
          </label>
          <button
            type="button"
