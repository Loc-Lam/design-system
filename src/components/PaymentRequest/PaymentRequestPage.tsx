...
type ViewMode = 'dashboard' | 'view' | 'edit' | 'list';
...
export default function PaymentRequestPage({ className }: PaymentRequestPageProps) {
        ...
        <div className={`flex flex-col h-full ${className}`}>
          ...
          <div className="bg-card border-b border-border px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-semibold text-foreground">Payment Requests</h1>
            ...
            <div className="max-w-6xl mx-auto space-y-6">
              ...
              <div className="bg-card border border-border rounded-lg">
                <div className="p-6 border-b border-border">
                  <div className="flex items-center justify-between">
                    <h2 className="text-lg font-medium text-foreground">Recent Payment Requests</h2>
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={handleViewList}
      ...
      <>
        <div className={`flex flex-col h-full ${className}`}>
          ...
          <div className="bg-card border-b border-border px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-semibold text-foreground">All Payment Requests</h1>
                <p className="text-sm text-muted-foreground mt-1">
  ...
  // Edit Form View (keep edit as a full page)
  if (viewMode === 'edit') {
    return (
      <div className={`flex flex-col h-full ${className}`}>
        {/* Page Header */}
    ...
    return (
      <div className={`flex flex-col h-full ${className}`}>
        ...
        <div className="bg-card border-b border-border px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-semibold text-foreground">Payment Request Details</h1>
              <p className="text-sm text-muted-foreground mt-1">
        ...
        <div className="flex-1 overflow-auto p-6 bg-background">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-card border border-border rounded-lg p-6">
              <h2 className="text-lg font-medium text-foreground mb-4">Request Information</h2>
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <dt className="text-sm font-medium text-muted-foreground">Title</dt>
                  <dd className="mt-1 text-sm text-foreground">{selectedRequest.title}</dd>
                </div>
                <div>
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-foreground">{selectedRequest.payeeDetails.name}</dd>
                </div>
                <div className="sm:col-span-2">
                  <dt className="text-sm font-medium text-muted-foreground">Description</dt>
                  <dd className="mt-1 text-sm text-foreground">{selectedRequest.description}</dd>
                </div>
              </dl>
            </div>
